  ...
  <header>
    <div class="container-fluid">
      <nav class="navbar navbar-expand-md navbar-light bg-light">
        <div class="container-fluid">
          <a href="" class="navbar-brand"><img style="max-width: 140px;" src="img/logoo.png" alt=""></a>
          ...
          <div id="menu" class="collapse navbar-collapse ">
            <ul class="navbar-nav ms-4">
              <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" id="navbarDropdown" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false"><small>Camaras</small></a>
                <ul class="dropdown-menu border-danger bg-dark btn-outline-danger" aria-labelledby="navbarDropdown">
                  <div class="col-4 w-100 border-danger">
                    <div class="list-group  bg-dark btn-outline-light  text-center" id="list-tab" role="tablist">
                      <a class="list-group-item list-group-item-action active bg-dark text-white btn-outline-danger" id="list-home-list" data-toggle="list" href="#2mpx" role="tab" aria-controls="home">2mpx</a>
                      <a class="list-group-item list-group-item-action bg-dark text-white btn-outline-danger" id="list-profile-list" data-toggle="list" href="#4mpx" role="tab" aria-controls="profile">4mpx</a>
                      <a class="list-group-item list-group-item-action bg-dark text-white btn-outline-danger" id="list-messages-list" data-toggle="list" href="#list-messages" role="tab" aria-controls="messages">Messages</a>
                      <a class="list-group-item list-group-item-action bg-dark text-white btn-outline-danger" id="list-settings-list" data-toggle="list" href="#list-settings" role="tab" aria-controls="settings">Settings</a>
                    </div>
                  </div>
                </ul>
              </li>
              ...
              <li class="nav-menu-item dropdown"><a class="nav-link dropdown-toggle" id="navbarDropdown" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false"><small>Controles de acceso</small></a>
                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                  <li><a href="" class="dropdown-item">dvrs</a></li>
                </ul>
              </li>
